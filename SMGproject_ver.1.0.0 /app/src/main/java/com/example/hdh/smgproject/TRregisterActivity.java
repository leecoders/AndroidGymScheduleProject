...
public class TRregisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trregister);
        ...
        validateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(userID.equals(""))
                {
                    AlertDialog.Builder builder = new AlertDialog.Builder(TRregisterActivity.this);
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if(success){
                                ...
                                validate = true;
                                idText.setBackground(ContextCompat.getDrawable(TRregisterActivity.this ,R.drawable.round_button_enabled));
                                validateButton.setBackground(ContextCompat.getDrawable(TRregisterActivity.this ,R.drawable.round_button_enabled));
                                return;
                            }
                            else{
                                AlertDialog.Builder builder = new AlertDialog.Builder(TRregisterActivity.this);
                ...
                RequestQueue queue = Volley.newRequestQueue(TRregisterActivity.this);
